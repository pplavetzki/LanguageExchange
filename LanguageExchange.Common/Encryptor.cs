/*
Based off of this stackoverflow answer: http://stackoverflow.com/questions/202011/encrypt-and-decrypt-a-string
Neardybeardo
*/
using System;
...
namespace LanguageExchange.Common
{
        ...
        where TDigest : IDigest, new()
    {
        ...
        public Encryptor(Encoding encoding, byte[] key, byte[] macKey)
        {
            ...
            this.key = key;
            this.Init(macKey, new Pkcs7Padding());
        }
